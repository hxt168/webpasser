...
public class XpathOldSelector {
	...
	public TagNode evaluateXPath(String xpath) throws XPatherException
	{
		Object[] objarr = rootTagNode.evaluateXPath(xpath);
	...
	public List<TagNode> evaluateListXPath(String xpath) throws XPatherException
	{
		Object[] objarr = rootTagNode.evaluateXPath(xpath);
	   if (objarr != null && objarr.length > 0)
        {
	...
	public String getHtml(TagNode node)
	{
		return htmlCleaner.getInnerHtml(node);
	}
	public static void main(String[] args) throws XPatherException, XPathExpressionException, ParserConfigurationException, TransformerException {
	    ...
	    //	       String xpath = "//div[not(@class)]"; 
	      String xpathExp = "//div[@class='ndownlist']//ul"; 
		 //test1
